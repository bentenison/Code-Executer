...
VALUES
  ...
  (2, INTERVAL '0:00:02.3', 204800, 'Error'),        -- 2.3 seconds, 200 KB, execution with an error
  ...
  (5, INTERVAL '0:00:01.2', 153600, 'Error'),        -- 1.2 seconds, 150 KB, execution with an error
